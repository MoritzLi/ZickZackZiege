public class Feld {
    ...
    public Feld(int pSpieleranzahl){
        ...
        int[][] feld = new int[feldgröße][feldgröße];
    }

    public int auswertung(int pSpieler, int pSpielerAnzahl, int[][] feld){
        int punkte = auswertungZiegenP(pSpieler, pSpielerAnzahl,feld);
        punkte = punkte + auswertungRammbock(pSpieler,pSpielerAnzahl,feld);
    ...
    private int auswertungKoruppte(int pSpieler, int pSpieleranzahl, int[][] feld){
        int punkte = 0;
        int spieler = pSpieler;
        int spieleranzahl = pSpieleranzahl;
        int feldgröße = spieleranzahl + 3;
