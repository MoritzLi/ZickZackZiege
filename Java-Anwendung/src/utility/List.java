...
public class List<ContentType> implements Iterable<ContentType> {
    ...
    /**
     * Gibt das Objekt an der aktuellen utility.Position des Pointers zurück
     *
    ...
    /**
     * Fügt ein neues Objekt vor die utility.Position des Pointers ein, steht dieser auf dem null-Objekt ({@link #hasAccess()} returns false), wird das Objekt ans
    ...
    /**
     * Fügt ein neues Objekt hinter die utility.Position des Pointers ein, steht dieser auf dem null-Objekt ({@link #hasAccess()} returns false), wird das Objekt ans
     * Ende der Liste angehängt. Der Pointer wird nicht verschoben.
     *
     * @param pContent Neues Listenobjekt
     */
     ...
     */
    public boolean find(ContentType object) {
